...
namespace SpinnerNav
{
    ...
    public static class StoryboardHelpers
    {
        ...
        #region [Zoom]
        /// <summary>
        /// Adds a zoom animation to the storyboard. (this is still in development)
        /// </summary>
        /// <param name="storyboard">The storyboard to add the animation to</param>
        /// <param name="seconds">The time the animation will take</param>
        /// <param name="offset">The distance to the right to start from</param>
        /// <param name="decelerationRatio">The rate of deceleration</param>
        public static void AddZoomIn(this Storyboard storyboard, float seconds, double offset = 1000, float decelerationRatio = 0.9f)
        {
            // Create the margin animate from right 
            var animation = new ThicknessAnimation
            {
                Duration = new Duration(TimeSpan.FromSeconds(seconds)),
                From = new Thickness(offset),
                To = new Thickness(0),
                DecelerationRatio = decelerationRatio
            };
        ...
        /// <summary>
        /// Adds a zoom animation to the storyboard
        /// </summary>
        /// <param name="storyboard">The storyboard to add the animation to</param>
        /// <param name="seconds">The time the animation will take</param>
        /// <param name="offset">The distance to the right to start from</param>
        /// <param name="decelerationRatio">The rate of deceleration</param>
        public static void AddZoomIn(this Storyboard storyboard, float seconds, double offset, float decelerationRatio = 0.9f)
        {
            // Create the margin animate from right 
            var animation = new ThicknessAnimation
            {
                Duration = new Duration(TimeSpan.FromSeconds(seconds)),
                From = new Thickness(1000),
                To = new Thickness(0),
                DecelerationRatio = decelerationRatio
            };
        ...
        /// <param name="storyboard">The storyboard to add the animation to</param>
        /// <param name="seconds">The time the animation will take</param>
        public static void AddFadeIn(this Storyboard storyboard, float seconds, bool useFrom = true)
        {
            // Create the margin animate from right 
            var animation = new DoubleAnimation
            {
        ...
        /// <param name="storyboard">The storyboard to add the animation to</param>
        /// <param name="seconds">The time the animation will take</param>
        public static void AddFadeOut(this Storyboard storyboard, float seconds, bool useFrom = true)
        {
            // Create the margin animate from right 
            var animation = new DoubleAnimation
            {
